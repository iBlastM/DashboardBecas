...
SRC   = pathlib.Path(__file__).parent / "data_solicitantes.json"
DST_A = pathlib.Path(__file__).parent / "data_sol_a.json"
DST_B = pathlib.Path(__file__).parent / "data_sol_b.json"
