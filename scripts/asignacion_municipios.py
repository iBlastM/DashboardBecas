"""
Asigna el municipio correcto a cada registro de data_dashboard.json
...
DATA_PATH    = BASE / "data_dashboard.json"
GEOJSON_PATH = BASE / "GeoJsons" / "MUNICIPIOS QRO.geojson"
OUTPUT_PATH  = BASE / "data_dashboard.json"

# ── 1. Leer el JSON (formato NDJSON: un objeto JSON por línea) ──────────────
print("Leyendo data_dashboard.json ...")
records = []
