...
document.addEventListener('datosListos', () => {
    ...
    const ids = [
        ...
        'kpi-etapa1-val','kpi-etapa2-val','kpi-publico-val','kpi-privado-val',
    ];
    ...
    const etapa1  = data.filter(d => d.ETAPA === '1RA ETAPA').length;
    const etapa2  = data.filter(d => d.ETAPA === '2DA ETAPA').length;
    ...
    document.getElementById('kpi-etapa1-val').textContent     = f(etapa1) + ' becarios';
    document.getElementById('kpi-etapa2-val').textContent     = f(etapa2) + ' becarios';
